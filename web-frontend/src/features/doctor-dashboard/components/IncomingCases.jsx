    ...
    <div className="bg-white/70 backdrop-blur-md border border-white/50 p-6 rounded-3xl shadow-sm w-full">
      ...
      <div className="bg-red-50 border border-red-100 p-4 rounded-2xl mb-4">
        ...
        <p className="text-gray-800 font-bold">
          Fungal Infection — 89% Probability
        </p>
        <p className="text-gray-600 text-sm mb-4">
          Symptoms: severe itching, skin rash, discolored patches. Male, 32
      ...
      <div className="space-y-4">
        {[
          {
            id: "Patient #225",
            status: "Eczema - Review Completed",
            time: "3 hours ago",
          },
          {
            id: "Patient #223",
            status: "Contact Dermatitis - Review Completed",
            time: "Yesterday",
          },
        ].map((patient, index) => (
          <div
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="text-xs bg-gray-100 px-3 py-1 rounded-lg text-gray-600">
                View
              </button>
            </div>
          </div>
